    ...
    <div class="row">
        <div class="col-md-8 articles" id="site-content">
           <article class="posts">
              ...
              <div class="content">
					<h2 class="description" >hotel Cantika Indah ini merupakan salah satu Hotel yang memiliki fasilitas yang tidak kalah dengan hotel lainnya, selain itu 
					hotel Cantika Indah ini memberikan harga yang pas dikantong. Selain itu Hotel Cantika Indah ini menyuguhkan pemandangan yang sangat indah, terdapat kolam 
					renang hangat jadi pagi para pelanggan dapat berenang dimalam hari dengan sinar bulan.</h2>
			  </div>
            </article>
        </div>
